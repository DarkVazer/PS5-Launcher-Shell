...
function GameTiles({ currentSection, currentIndex, activeGameTileIndex, setNavigation, lastGameTileOffset, games }) {
  const tiles = [
    ...
    ...games.slice(0, 8).map((game) => ({ background: game.cover, name: game.name })),
